...
class Observation(BodyXY):
    ...
    The disc parameters are initialised using :func:`disc_from_header` if the the input
    file was generated by `planetmapper` or :func:`center_disc` otherwise. This allows
    you to open a previously navigated file in `planetmapper` and not have to navigate
    it again.
